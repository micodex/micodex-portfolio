...
const colors: Record<string, string> = {
  gray: `px-2 py-1 rounded-md text-xs font-light bg-gray-50 dark:bg-gray-800 
    text-gray-600 dark:text-gray-300
    ring-2 ring-inset ring-gray-200 dark:ring-gray-600 `,

  sky: `px-2 py-1 rounded-md text-xs font-light bg-sky-50 dark:bg-sky-950 
    text-sky-600 dark:text-sky-400
    ring-2 ring-inset ring-sky-200 dark:ring-sky-800`,

  emerald: `px-2 py-1 rounded-md text-xs font-light bg-emerald-50 dark:bg-emerald-950 
